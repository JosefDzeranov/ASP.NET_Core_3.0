...
namespace OnlineShopWebApp.Models
{
    public class User
    {
        ...
        [StringLength(20, MinimumLength = 2, ErrorMessage = "Firstname should has length between 2 and 10 characters.")]
        public string FirstName { get; set; }

        [Required(ErrorMessage = "Please enter SecondName.")]
        [StringLength(20, MinimumLength = 2, ErrorMessage = "SecondName should has length between 2 and 10 characters.")]
        public string SecondName { get; set; }

        [Required(ErrorMessage ="Please enter Login.")]
        [StringLength(20, MinimumLength =2, ErrorMessage ="Login should has length between 2 and 10 characters.")]
