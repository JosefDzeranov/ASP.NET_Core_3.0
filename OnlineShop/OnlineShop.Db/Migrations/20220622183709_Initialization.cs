    ...
    public partial class Initialization : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDelivery", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDelivery_Address_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_UserDelivery_DeliveryInfoId",
                        column: x => x.DeliveryInfoId,
                        principalTable: "UserDelivery",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDelivery_AddressId",
                table: "UserDelivery",
                column: "AddressId");
        }
